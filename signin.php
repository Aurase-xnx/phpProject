...
<html lang="en" dir="ltr">
  ...
  <div class="flex-row">
    ...
    <input id="mail" class='lf--input' placeholder='Mail' type='text'>
  </div>
  <div class="flex-row">
  ...
  <div class="flex-row">
    ...
    <input id="confirmpassword" class='lf--input' placeholder='Confirm your password' type='password'>
  </div>
  <input class='lf--submit' type='submit' value='SIGN IN'>
</form>
<div class="plusplus">
